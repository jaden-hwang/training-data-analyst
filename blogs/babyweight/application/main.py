...
def predict():
  ...
  features['mother_married'] = bool2str('unmarried' not in data.keys() or data['unmarried'] == False)
  features['cigarette_use'] = bool2str('cigarette_use' in data.keys() and data['cigarette_use'] == True)
  features['alcohol_use'] = bool2str('alcohol_use' in data.keys() and data['alcohol_use'] == True)
#  features['mother_married'] = data['unmarried'] == false;
